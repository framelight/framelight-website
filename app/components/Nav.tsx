  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#f5f1eb]/75 backdrop-blur-xl border-b border-black/[0.06]">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 h-16 md:h-20 flex items-center justify-between">
        <a href="#" className="flex items-center shrink-0" aria-label="Framelight home">
          <img src="/black logoframelight .png" alt="Framelight" className="h-52 w-auto object-contain" />
        </a>

        <div className="flex items-center gap-5 md:gap-7">
          <div className="hidden md:flex items-center gap-7 font-sans">
            <a href="#problem" className="text-[13px] text-black/70 hover:text-black transition-colors">Why</a>
            <a href="#how" className="text-[13px] text-black/70 hover:text-black transition-colors">How it works</a>
            <a href="#moments" className="text-[13px] text-black/70 hover:text-black transition-colors">Moments</a>
          </div>
